        ...
        <form action="" method="POST">
          ...
          <div class="row">
            <div class="col-50">
              ...
              <input type="text" id="fname" name="firstname" placeholder="Aayush Bartaula">
              <label for="email"><i class="fa fa-envelope"></i> Email</label>
              <input type="text" id="email" name="email" placeholder="example@gmail.com">
              <label for="email"><i class="fa fa-envelope"></i> Number</label>
              <input type="text" id="email" name="number" placeholder="+9779863380519">
              <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
              <input type="text" id="adr" name="address" placeholder="Gujudhara">
              <label for="city"><i class="fa fa-institution"></i> City</label>
              <input type="text" id="city" name="city" placeholder="Gujudhara">
              <label for="city"><i class="fa fa-institution"></i> State</label>
              <input type="text" id="city" name="state" placeholder="Kathmandu">

              <div style="padding: 0px;" class="row">
                <div class="col-50">
                  <label for="state">Country</label>
                  <input type="text" id="state" name="country" placeholder="Nepal">
                </div>
                <div class="col-50">
                  <label for="zip">Pincode</label>
                  <input type="text" id="zip" name="pincode" placeholder="44611">
                </div>
              </div>
            </div>
            ...
            <div class="col-50">
              <div class="col-25">
                <div class="container">
                  ...
                  <p> <a href="book_details.php?details=<?php echo $fetch_cart['book_id']; ?>">
                      ...
                      <?php echo 'NPR ' . $fetch_cart['price'] . '/-' . ' x ' . $fetch_cart['quantity']; ?>)
                    </span> </p>
                  <?php
                    }
                  } else {
                  ...
                  <hr>
                  <p>Grand total : <span class="price" style="color:black">NPR <b>
              ...
              <div style="margin: 20px;">
                ...
                <div class="icon-container">
                            ...
                            <img class="icon"
                            src="images/logoo1.png">
                            <img class="icon"
                            src="images/logoo2.png">
                            <img class="icon"
                            src="images/logoo3.png">
                            <img class="icon"
                            src="images/logoo4.png">
                  
                      
                  
                  <!-- <i class="fa fa-cc-esewa" style="color:navy;"></i>
                ...
                <div class="inputBox">
                  ...
                  <select name="method" id="method">
                    <option value="Google Pay">Credit/Debit Card Pay</option>
                    <option value="Google Pay">Esewa</option>
                    <option value="Debit card">IME Pay</option>
